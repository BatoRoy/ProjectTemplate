...
QtObject {
    ...
    readonly property var palettes: ({
        "dark": {
            bg: "#161619", surface: "#1d1d21", card: "#212126", border: "#36363c",
            text: "#fafafa", subtext: "#a1a1aa", muted: "#71717a",
            green: "#34d399", red: "#f87171", yellow: "#fbbf24"
        },
        "dim": {
            bg: "#1d1d21", surface: "#242429", card: "#28282e", border: "#3f3f46",
            text: "#fafafa", subtext: "#a8a8b0", muted: "#7a7a83",
            green: "#34d399", red: "#f87171", yellow: "#fbbf24"
        },
        "light": {
            bg: "#fafafa", surface: "#ffffff", card: "#ffffff", border: "#e4e4e7",
            text: "#18181b", subtext: "#52525b", muted: "#a1a1aa",
    ...
    function mix(c, target, t) {
        return Qt.rgba(c.r + (target - c.r) * t,
                       c.g + (target - c.g) * t,
                       c.b + (target - c.b) * t, 1)
    }
    ...
    function presetColors(id) { return palettes[id] ?? palettes["dark"] }
}
